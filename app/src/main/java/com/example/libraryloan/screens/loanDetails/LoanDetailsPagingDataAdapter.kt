...
class LoanDetailsPagingDataAdapter(
    private val context: Context,
    private val listener: HomeListener,
) :
    PagingDataAdapter<LoanDetails, LoanDetailsPagingDataAdapter.HomeViewHolder>(ProductComparator) {
    /**
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HomeViewHolder {
        ...
        val layoutBinding = LoanDetailsRecyclerBinding.inflate(inflater, parent, false)
    ...
    inner class HomeViewHolder(private val binding: LoanDetailsRecyclerBinding) :
        ...
        fun bind(loanDetails: LoanDetails?, position: Int) {
            try {
                ...
                CoroutineScope(Dispatchers.Main).launch {
                    ...
                    binding.borrowReturn.setOnClickListener {
                        CoroutineScope(Dispatchers.Main).launch {
                            book?.id?.let { it1 -> listener.returnBook(loanDetails.id, it1) }
                        }
                    }
                }
